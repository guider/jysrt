...
const binary = lib_1.getEmbeddedSecp256k1Binary();
...
ava_1.default('[crypto] instantiateSecp256k1 with binary', async (t) => {
    const secp256k1 = await lib_1.instantiateSecp256k1Bytes(binary);
    t.true(secp256k1.verifySignatureDERLowS(sigDER, pubkeyCompressed, messageHash));
});
ava_1.default('[crypto] instantiateSecp256k1 with randomization', async (t) => {
    const secp256k1 = await lib_1.instantiateSecp256k1(crypto_1.randomBytes(32));
    t.true(secp256k1.verifySignatureDERLowS(sigDER, pubkeyUncompressed, messageHash));
});
ava_1.default('[crypto] secp256k1.addTweakPrivateKey', async (t) => {
...
ava_1.default('[fast-check] [crypto] secp256k1.addTweakPrivateKey', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[crypto] secp256k1.addTweakPublicKeyCompressed', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[fast-check] [crypto] secp256k1.addTweakPublicKeyCompressed', async (t) => {
    const secp256k1 = await secp256k1Promise;
    const equivalentToSecp256k1Node = fc.property(fcValidPrivateKey(secp256k1), (privateKey) => {
...
ava_1.default('[crypto] secp256k1.addTweakPublicKeyUncompressed', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[fast-check] [crypto] secp256k1.addTweakPublicKeyUncompressed', async (t) => {
    const secp256k1 = await secp256k1Promise;
    const equivalentToSecp256k1Node = fc.property(fcValidPrivateKey(secp256k1), (privateKey) => {
...
ava_1.default('[crypto] secp256k1.compressPublicKey', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[fast-check] [crypto] secp256k1.compressPublicKey', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[crypto] secp256k1.derivePublicKeyCompressed', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[fast-check] [crypto] secp256k1.derivePublicKeyCompressed', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[crypto] secp256k1.derivePublicKeyUncompressed', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[fast-check] [crypto] secp256k1.derivePublicKeyUncompressed', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[crypto] secp256k1.malleateSignatureDER', async (t) => {
    const secp256k1 = await secp256k1Promise;
    t.deepEqual(secp256k1.malleateSignatureDER(sigDER), sigDERHighS);
});
ava_1.default('[fast-check] [crypto] secp256k1.malleateSignatureDER', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[crypto] secp256k1.malleateSignatureCompact', async (t) => {
    const secp256k1 = await secp256k1Promise;
    t.deepEqual(secp256k1.malleateSignatureCompact(sigCompact), sigCompactHighS);
});
ava_1.default('[fast-check] [crypto] secp256k1.malleateSignatureCompact', async (t) => {
    const secp256k1 = await secp256k1Promise;
    const malleationIsJustNegation = fc.property(fcValidPrivateKey(secp256k1), fcUint8Array32(), (privateKey, message) => {
        const pubkey = secp256k1.derivePublicKeyCompressed(privateKey);
...
ava_1.default('[crypto] secp256k1.mulTweakPrivateKey', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[fast-check] [crypto] secp256k1.mulTweakPrivateKey', async (t) => {
    const secp256k1 = await secp256k1Promise;
    const equivalentToSecp256k1Node = fc.property(fcValidPrivateKey(secp256k1), (privateKey) => {
...
ava_1.default('[crypto] secp256k1.mulTweakPublicKeyCompressed', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[fast-check] [crypto] secp256k1.mulTweakPublicKeyCompressed', async (t) => {
    const secp256k1 = await secp256k1Promise;
    const equivalentToSecp256k1Node = fc.property(fcValidPrivateKey(secp256k1), (privateKey) => {
        const pubkeyC = secp256k1.derivePublicKeyCompressed(privateKey);
...
ava_1.default('[crypto] secp256k1.mulTweakPublicKeyUncompressed', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[fast-check] [crypto] secp256k1.mulTweakPublicKeyUncompressed', async (t) => {
    const secp256k1 = await secp256k1Promise;
    const equivalentToSecp256k1Node = fc.property(fcValidPrivateKey(secp256k1), (privateKey) => {
        const pubkeyU = secp256k1.derivePublicKeyUncompressed(privateKey);
...
ava_1.default('[crypto] secp256k1.normalizeSignatureCompact', async (t) => {
    const secp256k1 = await secp256k1Promise;
    t.deepEqual(secp256k1.normalizeSignatureCompact(sigCompactHighS), sigCompact);
});
ava_1.default('[fast-check] [crypto] secp256k1.normalizeSignatureCompact', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[crypto] secp256k1.normalizeSignatureDER', async (t) => {
    const secp256k1 = await secp256k1Promise;
    t.deepEqual(secp256k1.normalizeSignatureDER(sigDERHighS), sigDER);
});
ava_1.default('[fast-check] [crypto] secp256k1.normalizeSignatureDER', async (t) => {
    const secp256k1 = await secp256k1Promise;
    const malleateThenNormalizeEqualsInitial = fc.property(fcValidPrivateKey(secp256k1), fcUint8Array32(), (privateKey, hash) => {
...
ava_1.default('[crypto] secp256k1.recoverPublicKeyCompressed', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[fast-check] [crypto] secp256k1.recoverPublicKeyCompressed', async (t) => {
    const secp256k1 = await secp256k1Promise;
    const equivalentToSecp256k1Node = fc.property(fcValidPrivateKey(secp256k1), fcUint8Array32(), (privateKey, hash) => {
...
ava_1.default('[crypto] secp256k1.recoverPublicKeyUncompressed', async (t) => {
    const secp256k1 = await secp256k1Promise;
    t.deepEqual(secp256k1.recoverPublicKeyUncompressed(sigCompact, sigRecovery, messageHash), pubkeyUncompressed);
});
ava_1.default('[fast-check] [crypto] secp256k1.recoverPublicKeyUncompressed', async (t) => {
    const secp256k1 = await secp256k1Promise;
    const equivalentToSecp256k1Node = fc.property(fcValidPrivateKey(secp256k1), fcUint8Array32(), (privateKey, hash) => {
        const recoverableStuff = secp256k1.signMessageHashRecoverableCompact(privateKey, hash);
...
ava_1.default('[crypto] secp256k1.signMessageHashCompact', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[fast-check] [crypto] secp256k1.signMessageHashCompact', async (t) => {
    const secp256k1 = await secp256k1Promise;
    const equivalentToSecp256k1Node = fc.property(fcValidPrivateKey(secp256k1), fcUint8Array32(), (privateKey, hash) => {
...
ava_1.default('[crypto] secp256k1.signMessageHashDER', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[fast-check] [crypto] secp256k1.signMessageHashDER', async (t) => {
    const secp256k1 = await secp256k1Promise;
    const equivalentToSecp256k1Node = fc.property(fcValidPrivateKey(secp256k1), fcUint8Array32(), (privateKey, hash) => {
...
ava_1.default('[crypto] secp256k1.signMessageHashRecoverableCompact', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[fast-check] [crypto] secp256k1.signMessageHashRecoverableCompact', async (t) => {
    const secp256k1 = await secp256k1Promise;
    const equivalentToSecp256k1Node = fc.property(fcValidPrivateKey(secp256k1), fcUint8Array32(), (privateKey, hash) => {
...
ava_1.default('[crypto] secp256k1.signatureCompactToDER', async (t) => {
    const secp256k1 = await secp256k1Promise;
    t.deepEqual(secp256k1.signatureCompactToDER(sigCompact), sigDER);
});
ava_1.default('[fast-check] [crypto] secp256k1.signatureCompactToDER', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[crypto] secp256k1.signatureDERToCompact', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[fast-check] [crypto] secp256k1.signatureDERToCompact', async (t) => {
    const secp256k1 = await secp256k1Promise;
    const equivalentToSecp256k1Node = fc.property(fcValidPrivateKey(secp256k1), fcUint8Array32(), (privateKey, hash) => {
        const sig = secp256k1.signMessageHashDER(privateKey, hash);
...
ava_1.default('[crypto] secp256k1.uncompressPublicKey', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[fast-check] [crypto] secp256k1.uncompressPublicKey', async (t) => {
    const secp256k1 = await secp256k1Promise;
    const equivalentToSecp256k1Node = fc.property(fcValidPrivateKey(secp256k1), (privateKey) => {
        const pubkeyC = secp256k1.derivePublicKeyCompressed(privateKey);
...
ava_1.default('[crypto] secp256k1.validatePrivateKey', async (t) => {
    const secp256k1 = await secp256k1Promise;
    t.true(secp256k1.validatePrivateKey(privkey));
    t.false(secp256k1.validatePrivateKey(secp256k1OrderN));
});
ava_1.default('[fast-check] [crypto] secp256k1.validatePrivateKey', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[crypto] secp256k1.verifySignatureCompact', async (t) => {
    const secp256k1 = await secp256k1Promise;
    t.true(secp256k1.verifySignatureCompact(sigCompactHighS, pubkeyCompressed, messageHash));
});
ava_1.default('[fast-check] [crypto] secp256k1.verifySignatureCompact', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default('[crypto] secp256k1.verifySignatureCompactLowS', async (t) => {
    const secp256k1 = await secp256k1Promise;
    t.true(secp256k1.verifySignatureCompactLowS(sigCompact, pubkeyCompressed, messageHash));
});
ava_1.default('[fast-check] [crypto] secp256k1.verifySignatureCompactLowS', async (t) => {
    const secp256k1 = await secp256k1Promise;
    const equivalentToSecp256k1Node = fc.property(fcValidPrivateKey(secp256k1), fcUint8Array32(), fc.boolean(), fc.boolean(), (privateKey, message, compressed, invalidate) => {
        const pubUncompressed = secp256k1Node.publicKeyCreate(privateKey, false);
        const pubCompressed = secp256k1Node.publicKeyCreate(privateKey, true);
...
ava_1.default('[crypto] secp256k1.verifySignatureDER', async (t) => {
    const secp256k1 = await secp256k1Promise;
    t.true(secp256k1.verifySignatureDER(sigDERHighS, pubkeyCompressed, messageHash));
});
ava_1.default('[crypto] secp256k1.verifySignatureDERLowS', async (t) => {
    const secp256k1 = await secp256k1Promise;
    t.true(secp256k1.verifySignatureDERLowS(sigDER, pubkeyCompressed, messageHash));
...
ava_1.default('[fast-check] [crypto] secp256k1.verifySignatureDERLowS', async (t) => {
    const secp256k1 = await secp256k1Promise;
    const equivalentToSecp256k1Node = fc.property(fcValidPrivateKey(secp256k1), fcUint8Array32(), fc.boolean(), fc.boolean(), (privateKey, message, compressed, invalidate) => {
        const pubUncompressed = secp256k1Node.publicKeyCreate(privateKey, false);
        const pubCompressed = secp256k1Node.publicKeyCreate(privateKey, true);
...
ava_1.default('[crypto] secp256k1.signMessageHashSchnorr', async (t) => {
    const secp256k1 = await secp256k1Promise;
    t.deepEqual(secp256k1.signMessageHashSchnorr(privkey, schnorrMsgHash), sigSchnorr);
    t.throws(() => secp256k1.signMessageHashSchnorr(secp256k1OrderN, schnorrMsgHash));
});
ava_1.default('[fast-check] [crypto] secp256k1.signMessageHashSchnorr', async (t) => {
    const secp256k1 = await secp256k1Promise;
    const createsValidSignatures = fc.property(fcValidPrivateKey(secp256k1), fcUint8Array32(), fc.boolean(), (privateKey, hash, invalidate) => {
...
ava_1.default('[crypto] secp256k1.verifySchnorr', async (t) => {
    const secp256k1 = await secp256k1Promise;
    t.true(secp256k1.verifySignatureSchnorr(sigSchnorr, pubkeyCompressed, schnorrMsgHash));
    const pubkeyWithBrokenEncoding = pubkeyCompressed.slice().fill(0, 0, 1);
    t.false(secp256k1.verifySignatureSchnorr(sigSchnorr, pubkeyWithBrokenEncoding, schnorrMsgHash));
    const sigSchnorrWithBadSignature = sigSchnorr.slice().fill(0, 6, 7);
    t.false(secp256k1.verifySignatureSchnorr(sigSchnorrWithBadSignature, pubkeyCompressed, schnorrMsgHash));
